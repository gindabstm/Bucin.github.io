...
<div id="mainDiv">
	<div id="content">
		<div id="code">
			...
			<br/>
			<span class="comments">// Haiii kamuuu </span><br />
			Thank u for being a part of my life, Three words to express my deep feelings to you<br/>
			<strong><font color="red">I Miss U</font> Sayang<font color="red">&hearts;</font></strong><br />
		...
		<div id="loveHeart">
			...
			<div id="words">
				<div id="messages">
					...
					<b>GAUSAH NGADI NGADI LOH -_-<font color="red">&hearts;</font></b>;
